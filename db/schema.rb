...
ActiveRecord::Schema.define(version: 2020_07_09_142754) do
  ...
  create_table "handshakes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["thankee_id"], name: "index_handshakes_on_thankee_id"
    t.index ["thanker_id"], name: "index_handshakes_on_thanker_id"
  end
  ...
  add_foreign_key "handshakes", "users", column: "thankee_id"
  add_foreign_key "handshakes", "users", column: "thanker_id"
end
